...
var Layout = function () {
    ...
    //var resBreakpointMd = Zapatero.getResponsiveBreakpoint('md');
    ...
    var handleMainMenu = function () {
        ...
        $(".page-header .menu-toggler").on("click", function(event) {
            if (Zapatero.getViewPort().width < resBreakpointMd) {
    ...
    var handleMainMenuOnResize = function() {
        // handle hover dropdown menu for desktop devices only
        var width = Zapatero.getViewPort().width;
    ...
    var handleContentHeight = function() {
        ...
        if ($('body').height() < Zapatero.getViewPort().height) {            
            height = Zapatero.getViewPort().height -
    ...
    return {
        ...
        initHeader: function() {
            ...
            Zapatero.addResizeHandler(handleMainMenuOnResize); // handle main menu on window resize

            if (Zapatero.isAngularJsApp()) {      
        ...
        closeMainMenu: function() {
            ...
            if (Zapatero.getViewPort().width < resBreakpointMd && $('.page-header-menu').is(":visible")) { // close the menu on mobile view while laoding a page 
                $('.page-header .menu-toggler').click();
            }
        },

        getLayoutImgPath: function() {
            return Zapatero.getAssetsPath() + layoutImgPath;
        },

        getLayoutCssPath: function() {
            return Zapatero.getAssetsPath() + layoutCssPath;
        }
    };
