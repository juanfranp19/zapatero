...
const areaData = {
    "Salon Cooworking": {
        imagenes: [
            ...
            { id: 26, url: `${API_URL}/storage/public/equipos/imagen/creality-k1max.png` },
            { id: 27, url: `${API_URL}/storage/public/equipos/imagen/elegoo-4max.png` },
            { id: 28, url: `${API_URL}/storage/public/equipos/imagen/elegoo-4plus.png` },
            { id: 29, url: `${API_URL}/storage/public/equipos/imagen/creality-ender6.png` },
            { id: 30, url: `${API_URL}/storage/public/equipos/imagen/creality-cr6.png` },
            { id: 31, url: `${API_URL}/storage/public/equipos/imagen/ender-cr30.png` },
            { id: 32, url: `${API_URL}/storage/public/equipos/imagen/procusini-5-alimentos.png` },
            { id: 33, url: `${API_URL}/storage/public/equipos/imagen/epson-surecolor-s80600.png` },
            { id: 34, url: `${API_URL}/storage/public/equipos/imagen/plotter-de-corte-gcc-jaguar-iv.png` },
            { id: 35, url: `${API_URL}/storage/public/equipos/imagen/hp-designjet-800.png` },
            { id: 36, url: `${API_URL}/storage/public/equipos/imagen/inyectora-de-plastico-boy-35-e-pro.png` },
            { id: 37, url: `${API_URL}/storage/public/equipos/imagen/termoconformadora-formech-508-dt.png` },
            { id: 38, url: `${API_URL}/storage/public/equipos/imagen/escaner-handyscan-revscan.png` },
            { id: 39, url: `${API_URL}/storage/public/equipos/imagen/escaner-artec-space-spider.png` },
            { id: 40, url: `${API_URL}/storage/public/equipos/imagen/escaner-artec-eva.png` },
        ],
    },
    "Sala VR": {
        imagenes: [
